...
//     ///
//     ///
//     pub fn find_layer(&self, name: &str) -> Option<&InfoElement> {
...
//     ///
//     ///
//     pub fn find_layer_mut(&mut self, name: &str) -> Option<&mut InfoElement> {
//         self.elements
//             .iter_mut()
//             .find(|element| element.name() == name)
//     }

//     pub fn insert(&mut self, topic: String, element: InfoElement) -> Result<(), Error> {
//         //
//         // Debug
...
//             .insert(
//                 topic.to_string(),
//                 InfoElement::Interface(ElementInterface::new("topic1", Vec::new())),
//             )
//             .unwrap();
